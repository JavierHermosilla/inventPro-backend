...
export async function checkExportsAvailability(): Promise<boolean> {
  ...
  try {
    ...
    exportsAvailabilityCache = Boolean(res.data && (res.data as any).ok === true);
  } catch {
...
export const exportsApi = {
  ...
  async downloadFullInventoryXLSX() {
    ...
    await downloadBlob("/exports/full-inventory.xlsx", name, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");
  },
