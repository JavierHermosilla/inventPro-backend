...
export const createUserSchema = z.object({
  body: z.object({
    username: z
      ...
      .max(30, { message: 'El nombre de usuario no debe superar los 30 caracteres' }),
    name: z
    ...
    password: z
      ...
      .max(64, { message: 'La contraseña no debe superar los 64 caracteres' })
...
export const updateUserSchema = z.object({
  body: z.object({
    ...
    password: z
      ...
      .optional(),
    phone: z.string().regex(phoneRegex, { message: 'Formato de teléfono inválido' }).optional(),
